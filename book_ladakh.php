...
<div class="heading" style="background:url(images/Ladakh1.jpg) no-repeat">
   <h1 style="color: #000000ab" >Ladakh Package</h1>
</div>
...
<section class="booking">
   ...
   <form action="data_ladakh.php" method="post" class="book-form">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>where to :</span>
            <input type="text" value="Ladakh Package" name="location" required>
         </div>
         <div class="inputBox">
            <span>how many :</span>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="book_ladakh.php #booking"> book</a>
      </div>
