...
<div class="heading" style="background:url(images/img-8.jpg) no-repeat">
   <h1 style="color: #4aff4a">Kerala Tour</h1>
</div>
...
<section class="booking">
   ...
   <form action="data_kerala.php" method="post" class="book-form">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>where to :</span>
            <input type="text" value="Kerala Tour" name="location" required>
         </div>
         <div class="inputBox">
            <span>how many :</span>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="book_kerela.php #booking"> book</a>
      </div>
